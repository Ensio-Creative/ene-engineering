    ...
    <main className="bg-white">
      ...
      <section className="relative lg:h-[90vh] h-[70vh] flex items-end justify-start lg:p-10 p-4 bg-black">
        ...
        <div className="relative z-10 text-white mb-10">
          <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">Excellence in precision<br />engineering & <br /> manufacturing</h1>
          <Link to={"/contact"}>
      ...
      <main className="lg:mx-0 mx-4">
        <div className="max-w-7xl mx-auto">
          <video className="w-full mb-20 lg:h-[80vh] h-[50vh] object-cover" autoPlay loop muted>
        ...
        <section className="max-w-7xl mx-auto mb-20">
          <h3 className="lg:text-5xl text-3xl font-bold mb-8">Why ENE Engineering</h3>
                  ...
                  >
                    {process.map((single, index) => (
                      <SwiperSlide key={index} className="">
                        <div className="bg-[#F0F0F0] px-6 py-10">
