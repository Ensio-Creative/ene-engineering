    ...
    return (
        <main>
            ...
            <main className='lg:px-0 px-4'>
                <section className='max-w-7xl mx-auto lg:grid grid-cols-2 gap-8 lg:my-32 my-20'>
                    <img src="/images/ene-engineering-about-us-1.jpg" className='lg:mb-0 mb-6' alt="" />
                    <div className='my-auto'>
                        <h1 className='lg:text-5xl text-3xl font-bold mb-8'>Who We Are</h1>
